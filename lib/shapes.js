...
class LogoGenerator {
    constructor(text, textColor, fontFamily, shape, shapeColor) {
        this.text = text;
    ...
    <text x="50" y="50" fill="${this.textColor}" text-anchor="middle" font-size="1.2rem" font-family="${this.fontFamily}">${this.text}</text>
</svg>`;
    }
}
